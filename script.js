...
function calculateCorrectAnswer() {
    ...
    // Check the operator, if it's a valid operator, it calculates the correct answer, and
    // returns an array. Then sets the game type we want for the next game (the same
